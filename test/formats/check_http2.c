...
static const M_uint8 test_dat01_frame[] = {
	0x00, 0x00, 0x4c, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01,
...
START_TEST(check_http2_frame_funcs)
{
	...
	M_http2_reader_read(h2r, test_dat01_frame, sizeof(test_dat01_frame), &len);
	ck_assert_msg(len == sizeof(test_dat01_frame), "Should have read '%zu' not '%zu'", sizeof(test_dat01_frame), len);
